   ...
   return (
      <>
         ...
         <div className="bg-[#ffffff]  text-gray-800 flex justify-between items-center  lg:justify-around md:hidden">
            <Link to='/' className="ms-4 font-semibold text-gray-500 border border-[#b0ffef] p-1 border-x-0 rounded-lg text-xl">Sheib Ali</Link>
            <button
         ...
         <div className="flex justify-around bg-white ">
            <div className="lg:w-[200px] ">
               <div
                  className={`z-10 bg-white border md:fixed  flex flex-col justify-between overflow-x-hidden  w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 transform ${isActive && "-translate-x-full"
               ...
               >
                  <div className="">
                     ...
                     <div className="menu lg:bg-hidding items-center text-base-content">
                        ...
                        <div className="mt-4" >
                           <h3 className="text-lg text-start mb-4">Dashboard</h3>
                           {isAdmin &&
                              <div className="my-4">
                                       ...
                                       <div key={index} className="">
                                          <div onClick={() => handleClick(2)}>
                                             <div className="flex justify-between gap-24 items-center cursor-pointer">
                                                <div className=""><p>{section.title}</p></div>
                                                <div>
                                                   {activeIndex === 2 ? (
                                                      <IoMdArrowDropup className="text-lg" />
                                                   ) : (
